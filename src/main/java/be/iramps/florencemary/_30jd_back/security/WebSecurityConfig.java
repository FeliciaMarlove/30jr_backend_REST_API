...
import static be.iramps.florencemary._30jd_back.models.UserRole.*;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .authenticated()
                .and()
                //form based authN (forms -> full control), username/password, can logout, https recommended, most apps standard, cookie SESSIONID
                /*
                 ...
                 */
                .formLogin()
                //.loginPage("url").permitAll() //internal only? view! (not endpoint)
                ;
    }
